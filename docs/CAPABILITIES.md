...
| Project image and screenshots | Canonical submission package complete | Twelve real browser/Android captures cover the public site, validated deterministic preview, deployed audit timeline, signed responder claim/lease/resolution and signed Android release Drill. Signed paths are redacted in provenance. The final 1800×1200 project image combines a reviewed Higgsfield story frame with the real signed-Android drill | Optional score improvement: repeat the preview/trace captures after AgentCore is available |
| Demo video | Final 4:26 cinematic submission master produced | A 1920×1080 H.264/AAC master combines three reviewed Higgsfield scenes, a complete Higgsfield Seed Audio narration using the Maeve preset, an original project-authored score, animated canonical product evidence, synchronized SRT/VTT files, a 1280×720 thumbnail, editable FFmpeg timeline and complete provenance. The narration and visible UI truthfully disclose the AgentCore quota block and deterministic fallback | Upload publicly to YouTube or Vimeo |
...
- Submission media: twelve canonical/browser and signed-Android captures, a 1800×1200 project image, and a visually reviewed 4:26 1920×1080 cinematic master are present. The film includes six Higgsfield visual assets, a full Higgsfield Seed Audio voice-over, an original score, SRT/VTT captions, a 1280×720 thumbnail, an editable timeline and complete asset/capture hashes. The canonical deterministic fallback is explicitly disclosed in the UI and narration.
