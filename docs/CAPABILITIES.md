...
| Demo video | Public and verified | [The 2:17 public YouTube demo](https://youtu.be/hDcBwr9dFsY) uses the conversational male Marcus preset through Higgsfield Qwen Audio 3.0 TTS Flash, an original project-authored score, a recorded public judge flow, recorded Android emulator proof, project architecture, 15 published timed English captions, a 1280×720 GPT Image 2 thumbnail, an editable FFmpeg build, and complete local provenance. YouTube reported no copyright or Community Guidelines issues. The narration and visible UI truthfully disclose the AgentCore quota block and deterministic fallback | Complete final Devpost submission |
...
- Submission media: twelve canonical browser and signed-Android still captures, a 1800×1200 GPT Image 2 project image, and the published, visually reviewed 2:17 1920×1080 master are present. The film uses recorded live product motion, the male Marcus preset through Higgsfield Qwen Audio 3.0 TTS Flash, an original score, 15 published timed English captions, a 1280×720 GPT Image 2 thumbnail, an editable FFmpeg build, and complete asset/capture hashes. It contains no generated character footage or stock footage. The canonical deterministic fallback is explicitly disclosed in the UI and narration.
