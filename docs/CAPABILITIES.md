...
| Bonus posts | Public and submitted | Three Builder Center posts cover the product principle, governed AgentCore and idempotent workflow; all titles include “Agents for Humans,” and all three public URLs are saved in the Devpost bonus field | No remaining hackathon action |
...
- Submission media: twelve canonical browser and signed-Android still captures, a 1800×1200 GPT Image 2 project image, and the published, visually reviewed 2:17 1920×1080 master are present. The film uses recorded live product motion, the male Marcus preset through Higgsfield Qwen Audio 3.0 TTS Flash, an original score, 15 published timed English captions, a 1280×720 GPT Image 2 thumbnail, an editable FFmpeg build, and complete asset/capture hashes. It contains no generated character footage or stock footage. The canonical deterministic fallback is explicitly disclosed in the UI and narration. Three optional bonus posts are public on AWS Builder Center and their URLs are saved in the submitted Devpost entry.
